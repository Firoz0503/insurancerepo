describe('Insurance Project', () => {
    ...
    it('Insurance Framework', function () {
        ...
        cy.get('#quotation_vehicle_attributes_parkinglocation').select('Driveway/Carport')
        cy.get('#quotation_vehicle_attributes_policystart_1i').select('2016')
        cy.get('#quotation_vehicle_attributes_policystart_2i').select('January')
        cy.get('#quotation_vehicle_attributes_policystart_3i').select('15')
