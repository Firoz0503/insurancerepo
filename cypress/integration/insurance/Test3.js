describe('Insurance Project', () => {
    ...
    it('Insurance Framework', function () {
        ...
        cy.get('#quotation_vehicle_attributes_parkinglocation').select('Unlocked Garage')
        cy.get('#quotation_vehicle_attributes_policystart_1i').select('2020')
        cy.get('#quotation_vehicle_attributes_policystart_2i').select('July')
        cy.get('#quotation_vehicle_attributes_policystart_3i').select('12')
